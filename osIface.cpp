////////////////////////////////////////////////////////////////////
// ~/public_html/fw/osIface.cpp 2025-07-15 18:16 dwg -            //
...
{
    std::string ssFile = pszFile;
    std::string ssPath = gpSh->m_pShMemng->szScriptsFQDS;
                                      ...
                                      bool bDebug)
{
    ...
    ssCommand.append(gpSh->m_pShMemng->szCgiRoot);
                                  ...
                                  bool bDebug)
{
    ...
    ssURL.append(gpSh->m_pShMemng->szCgiRoot);
