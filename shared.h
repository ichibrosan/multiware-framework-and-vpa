...
// /**
//  * @var gpLog
//  * @brief A global logging object used to handle and record log messages throughout the application.
//  *
//  * The gpLog variable is typically utilized for logging purposes, aiding in monitoring
//  * and debugging by capturing messages, errors, or events generated by the system or application.
//  * It can be configured to manage different levels of logging such as debug, info, warning, and error.
//  * The specific implementation and configuration of gpLog depend on the logging library or framework in use.
//  */
// extern CLog *gpLog;
...
// /**
//  * @var gpOS
//  * @brief Represents the operating system information or configuration.
//  *
//  * This variable is utilized to store or manage details related to the
//  * operating system, which may include version, type, or other relevant
//  * metadata for system-specific operations.
//  *
//  * It may be used across the program wherever operating system-specific
//  * parameters or functionality are required.
//  */
// extern osIface * gpOS;
