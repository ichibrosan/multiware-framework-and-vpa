...
private:
     ...
     */
    size_t parseServiceBlock(const std::vector<std::string>& lines, size_t startIndex, XinetdServiceConfig& service) const;
...
public:
     ...
     * @return true if successful
     */
    bool updateService(const std::string& serviceName, const XinetdServiceConfig& config);
