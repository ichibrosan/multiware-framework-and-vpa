 ...
 *
 * This variable serves as a pointer to the current environment configuration
 * or settings in use. It allows accessing or modifying environmental
 * properties globally within the application where it is utilized.
 *
 * @note It is necessary to ensure proper initialization of `gpEnv` before use
